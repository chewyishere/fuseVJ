...
particle::particle(){
    ...
    pos2.set(ofGetWidth()/2,ofGetHeight()/2);
    ...
    color = ofColor(ofRandom(20),ofRandom(20),ofRandom(20),90);
...
void particle::draw(){
    ...
    float dx = pos2.x - prevPos.x;
	float dy = pos2.y - prevPos.y;
    ...
    img->draw(-img->width/2,-img->height/2, scl.x, scl.y);
    ofPopMatrix();
